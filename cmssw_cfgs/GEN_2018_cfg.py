...
options.register("decaytype", 1, VarParsing.multiplicity.singleton, VarParsing.varType.int, "")
options.register("forcing", 0, VarParsing.multiplicity.singleton, VarParsing.varType.int, "")
options.register("matching", 1, VarParsing.multiplicity.singleton, VarParsing.varType.int, "")
